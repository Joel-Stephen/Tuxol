...
// void cancelAlertBox({context, msg,text1,text2,route,double insetPadding,double contentPadding,double titlePadding}) {
//   showGeneralDialog(
//       context: context,
...
//       pageBuilder: (BuildContext buildContext, Animation animation,
//           Animation secondaryAnimation) {
//         return OtpMessage(title: title, route:route,stayOnPage: stayOnPage,);
//       });
// }
